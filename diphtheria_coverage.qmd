...
Plot.plot({
  ...
  marks: [
    ...
    Plot.line(coverage_for_selected, {x: "curr_eval_year", y: "dose_1_cov", stroke: "red", 
                  title: (d) => `≥1 dose`}),
    Plot.dot(coverage_for_selected, {x: "curr_eval_year", y: "dose_1_cov", fill: "red", 
                  title: (d) => `≥1 dose`}),
    // Coverage for at least 2 doses
    Plot.line(coverage_for_selected, {x: "curr_eval_year", y: "dose_2_cov", stroke: "blue", 
                  title: (d) => `≥2 dose`}),
    Plot.dot(coverage_for_selected, {x: "curr_eval_year", y: "dose_2_cov", fill: "blue", 
                  title: (d) => `≥2 dose`}),
    // Coverage for at least 3 doses
    Plot.line(coverage_for_selected, {x: "curr_eval_year", y: "dose_3_cov", stroke: "purple", 
                  title: (d) => `≥3 dose`}),
    Plot.dot(coverage_for_selected, {x: "curr_eval_year", y: "dose_3_cov", fill: "purple", 
                  title: (d) => `≥3 dose`}),
    ...
    Plot.dot(coverage_for_selected, {x: "curr_eval_year", y: "dose_1_on_schedule_cov", 
    ...
    Plot.dot(coverage_for_selected, {x: "curr_eval_year", y: "dose_2_on_schedule_cov", 
    ...
    Plot.dot(coverage_for_selected, {x: "curr_eval_year", y: "dose_3_on_schedule_cov", 
